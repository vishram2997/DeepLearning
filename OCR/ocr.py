...
dataset = dataset[['date','Open', 'High', 'Low', 'Close','volume']]


testDataset = np.array([[1/30/2019,1623,1676.95,1619.68,1670.43,5783822]])
...
plt.legend()
#print(trade_dataset['Tomorrows Returns'])
